  ...
  <div class="addr-box">
    ...
    <el-card class="order-card">
      ...
      <el-table :data="order.items">
        <el-table-column width="200px" align="center" label="商品信息">
      ...
      <div style="padding: 20px;float:right">
        ...
        <el-button @click="checkout" style="float:right;margin-left:20px;" type="primary">提交订单</el-button>
      </div>
    </el-card>
  </div>
</template>
...
<script>
    import {delAddress, getOrder, listAddress, newAddress, updateAddress} from "../../api/member";
